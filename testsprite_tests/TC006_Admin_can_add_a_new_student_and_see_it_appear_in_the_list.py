...
async def run_test():
    ...
    try:
        ...
        # -> Fill the admin username into the NIP / NIS field, then fill the password and submit the login form.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Test Siswa A')]").nth(0).is_visible(), "The student list should show Test Siswa A after creating the new student"
